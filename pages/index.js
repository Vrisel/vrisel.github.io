  ...
  return (
    <Layout>
      <Container className="body-font" sx={{ width: "99%" }}>
        <Box component="section" mt={2} mb={7} aria-labelledby="home">
          ...
          <Box>
            ...
            <Box component="ul" className={classes.mbList}>
              ...
              <Typography component="li">
                모든 <strong>사람이 사람답게</strong> 살 수 있는 세상을
                꿈꿉니다.
                <Box component="ul">
                  <Typography component="li">
        ...
        <ContactsSection mb={7} />
        <Box component="section" mb={7} aria-labelledby="tmi">
          <Typography component="h2" variant="h5" id="tmi">
            <ArticleIcon />
...
const SkillsSection = (props) => {
  return (
    <Box component="section" mb={props.mb} aria-labelledby="skills">
      <Typography component="h2" variant="h5" id="skills">
        <DevIcon />
        Skills
      </Typography>
      <Box component="dl" className={props.dlClass}>
...
const ProjectsSection = (props) => {
  return (
    <Box component="section" mb={props.mb} aria-labelledby="projects">
      <Typography component="h2" variant="h5" id="projects">
        <InventoryIcon />
        Projects
      </Typography>
      <Box
...
const ContactsSection = (props) => {
  return (
    <Box component="section" mb={props.mb} aria-labelledby="contacts">
      <Typography component="h2" variant="h5" id="contacts">
        <ContactsIcon />
        Contacts and Links
      </Typography>
      <Box component="ul">
